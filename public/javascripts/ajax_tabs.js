function tabselect(tid, tab) {
  var tablist = $(tid).getElementsByTagName('li');
  var nodes = $A(tablist);
...
function paneselect(pid, pane) {
  var panelist = $(pid).getElementsByTagName('li');

...
describe BlogsController do
  ...
  it "maps #create" do
    route_for(:controller => "blogs", :action => "create").should == {:path => "/blogs", :method => :post}
  end

  it "maps #update" do
    route_for(:controller => "blogs", :action => "update", :id => "1").should == {:path =>"/blogs/1", :method => :put}
  end
  
    it "maps #destroy" do
      route_for(:controller => "blogs", :action => "destroy", :id => "1").should == {:path =>"/blogs/1", :method => :delete}
    end
  end
